...
\shellcmd{git clone http://tas.lsr.ei.tum.de/TAS201617/tas\_group\_X.git}  
...
\shellcmd{cd \textasciitilde/catkin\_ws/src/tas\_group\_X/tas/shell\_scripts} where X is your group number \\
\shellcmd{sudo ./ros\_setup.sh} and type your password. \\
...
\shellcmd{roslaunch tas hardware.launch}
...
\shellcmd{roslaunch tas odom.launch} \\

Picture \reffig{rqt_odom} shows the running nodes and topics for the odometry.
...
\begin{figure}[h]
	\centering
		\includegraphics[width=\textwidth]{coordsystems_img}
...
\shellcmd{roslaunch tas move\_base.launch}
